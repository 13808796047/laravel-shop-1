@extends('layouts.app')
@section('title', ($user_address->id?'编辑':'新增').'收货地址')
                    ...
                    <user-addresses-create-and-edit inline-template>
                        @if($user_address->id)
                            <form class="form-horizontal" role="form"
                                  action="{{ route('user_addresses.update',  $user_address) }}"
                                  method="post">
                                {{ method_field('PUT') }}
                                @else
                                    <form class="form-horizontal" role="form"
                                    ...
                                    <!-- 注意这里多了 @change -->
                                        <select-district
                                                :init-value="{{ json_encode([$user_address->province, $user_address->city, $user_address->district]) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="zip"
                                                       value="{{ old('zip', $user_address->zip) }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="contact_name"
                                                       value="{{ old('contact_name', $user_address->contact_name) }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="contact_phone"
                                                       value="{{ old('contact_phone', $user_address->contact_phone) }}">
                                            </div>
                                        </div>
